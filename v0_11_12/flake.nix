{
  ...
  inputs.src-hmisc-v0_11_12.flake = false;
  inputs.src-hmisc-v0_11_12.ref   = "refs/tags/v0.11.12";
  inputs.src-hmisc-v0_11_12.owner = "haxscramper";
  inputs.src-hmisc-v0_11_12.repo  = "hmisc";
  inputs.src-hmisc-v0_11_12.dir   = "";
  inputs.src-hmisc-v0_11_12.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-hmisc-v0_11_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-hmisc-v0_11_12";
