{
  ...
  inputs.src-hmisc-v0_4_0.flake = false;
  inputs.src-hmisc-v0_4_0.ref   = "refs/tags/v0.4.0";
  inputs.src-hmisc-v0_4_0.owner = "haxscramper";
  inputs.src-hmisc-v0_4_0.repo  = "hmisc";
  inputs.src-hmisc-v0_4_0.dir   = "";
  inputs.src-hmisc-v0_4_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-hmisc-v0_4_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-hmisc-v0_4_0";
