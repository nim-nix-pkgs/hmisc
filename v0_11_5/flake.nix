{
  ...
  inputs.src-hmisc-v0_11_5.flake = false;
  inputs.src-hmisc-v0_11_5.ref   = "refs/tags/v0.11.5";
  inputs.src-hmisc-v0_11_5.owner = "haxscramper";
  inputs.src-hmisc-v0_11_5.repo  = "hmisc";
  inputs.src-hmisc-v0_11_5.dir   = "";
  inputs.src-hmisc-v0_11_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-hmisc-v0_11_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-hmisc-v0_11_5";
